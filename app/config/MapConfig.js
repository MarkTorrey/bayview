    ...
    define(['esri/layers/FeatureLayer'], function(FeatureLayer) {
      return {
        ...
        operationalLayers: [
          ...
          {
            type: 'Feature Layer',
            url: 'http://arcgis4.roktech.net/arcgis/rest/services/Bay/BayView/MapServer/3',
            options: {
              id: 'hydrants',
              title: 'Hydrants',
              opacity: 1,
          ...
          {
            type: 'Feature Layer',
            url: 'http://arcgis4.roktech.net/arcgis/rest/services/Bay/BayView/MapServer/4',
            options: {
              id: 'futurelanduse',
          ...
          {
            type: 'Feature Layer',
            url: 'http://arcgis4.roktech.net/arcgis/rest/services/Bay/BayView/MapServer/5',
            options: {
              id: 'zoning',
              title: 'Zoning',
              opacity: .5,
          ...
          {
            type: 'Feature Layer',
            url: 'http://arcgis4.roktech.net/arcgis/rest/services/Bay/BayView/MapServer/6',
            options: {
          ...
          {
            type: 'Feature Layer',
            url: 'http://arcgis4.roktech.net/arcgis/rest/services/Bay/BayView/MapServer/7',
            options: {
              id: 'onefootcontours',
          ...
          {
            type: 'Feature Layer',
            url: 'http://arcgis4.roktech.net/arcgis/rest/services/Bay/BayView/MapServer/8',
            options: {
              id: 'easements',
              title: 'Easements',
              opacity: 1,
          ...
          {
            type: 'Feature Layer',
            url: 'http://arcgis4.roktech.net/arcgis/rest/services/Bay/BayView/MapServer/9',
            options: {
              id: 'femafloodways',
          ...
          {
            type: 'Feature Layer',
            url: 'http://arcgis4.roktech.net/arcgis/rest/services/Bay/BayView/MapServer/10',
            options: {
              id: 'femacobraopa',
          ...
          {
            type: 'Feature Layer',
            url: 'http://arcgis4.roktech.net/arcgis/rest/services/Bay/BayView/MapServer/11',
            options: {
              id: 'FEMAfloodzones',
          ...
          {
            type: 'Feature Layer',
            url: 'http://arcgis4.roktech.net/arcgis/rest/services/Bay/BayView/MapServer/12',
            options: {
              id: 'femafirmindex',
          ...
          {
            type: 'Feature Layer',
            url: 'http://arcgis4.roktech.net/arcgis/rest/services/Bay/BayView/MapServer/13',
            options: {
              id: 'wetlands',
              title: 'Wetlands',
              opacity: .5,
          ...
          {
            type: 'Feature Layer',
            url: 'http://arcgis4.roktech.net/arcgis/rest/services/Bay/BayView/MapServer/14',
            options: {
              id: 'soils',
              title: 'Soils',
              opacity: .5,
          ...
          {
            type: 'Feature Layer',
            url: 'http://arcgis4.roktech.net/arcgis/rest/services/Bay/BayView/MapServer/15',
            options: {
              id: 'evacuationzones',
          ...
          {
            type: 'Feature Layer',
            url: 'http://arcgis4.roktech.net/arcgis/rest/services/Bay/BayView/MapServer/16',
            options: {
          ...
          {
            type: 'Feature Layer',
            url: 'http://arcgis4.roktech.net/arcgis/rest/services/Bay/BayView/MapServer/17',
            options: {
              id: 'StormSurge',
              title: 'Storm Surge',
              opacity: .5,
          ...
          {
            type: 'Feature Layer',
            url: 'http://arcgis4.roktech.net/arcgis/rest/services/Bay/BayView/MapServer/18',
            options: {
          ...
          {
            type: 'Feature Layer',
            url: 'http://arcgis4.roktech.net/arcgis/rest/services/Bay/BayView/MapServer/19',
            options: {
          ...
          {
            type: 'Feature Layer',
            url: 'http://arcgis4.roktech.net/arcgis/rest/services/Bay/BayView/MapServer/20',
            options: {
          ...
          {
            type: 'Feature Layer',
            url: 'http://arcgis4.roktech.net/arcgis/rest/services/Bay/BayView/MapServer/21',
            options: {
          ...
          {
            type: 'Feature Layer',
            url: 'http://arcgis4.roktech.net/arcgis/rest/services/Bay/BayView/MapServer/22',
            options: {
              id: 'serviceareas',
              title: 'Service Areas',
              opacity: .5,
          ...
          {
            type: 'Feature Layer',
            url: 'http://arcgis4.roktech.net/arcgis/rest/services/Bay/BayView/MapServer/23',
            options: {
              id: 'beachaccess',
              title: 'Beach Access',
              opacity: 1,
          ...
          {
            type: 'Feature Layer',
            url: 'http://arcgis4.roktech.net/arcgis/rest/services/Bay/BayView/MapServer/24',
            options: {
              id: 'boatramps',
              title: 'Boat Ramps',
              opacity: 1,
          ...
          {
            type: 'Feature Layer',
            url: 'http://arcgis4.roktech.net/arcgis/rest/services/Bay/BayView/MapServer/25',
            options: {
              id: 'libraries',
              title: 'Libraries',
              opacity: 1,
          ...
          {
            type: 'Feature Layer',
            url: 'http://arcgis4.roktech.net/arcgis/rest/services/Bay/BayView/MapServer/26',
            options: {
              id: 'recycling',
              title: 'Recycling',
              opacity: 1,
          ...
          {
            type: 'Feature Layer',
            url: 'http://arcgis4.roktech.net/arcgis/rest/services/Bay/BayView/MapServer/27',
            options: {
              id: 'schools',
              title: 'Schools',
              opacity: 1,
          ...
          {
            type: 'Feature Layer',
            url: 'http://arcgis4.roktech.net/arcgis/rest/services/Bay/BayView/MapServer/28',
            options: {
              id: 'parks',
              title: 'Parks',
              opacity: 1,
